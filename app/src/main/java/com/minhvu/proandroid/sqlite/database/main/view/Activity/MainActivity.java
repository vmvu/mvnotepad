...
public class MainActivity extends AppCompatActivity implements SortView {
    ...
    void setupInit() {
        ...
        btnDeletePage =  findViewById(R.id.btnDeletePage);

        btnSort.setOnClickListener(v -> sortVew());
        ...
        btnSyncCloud = findViewById(R.id.btnSync_cloud);

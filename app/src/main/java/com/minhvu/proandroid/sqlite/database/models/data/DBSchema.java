...
public class DBSchema extends SQLiteOpenHelper {
    ...
    private static DBSchema mHelper = null;

    public static DBSchema getInstance(Context context){
        if(mHelper == null){
    ...
    private DBSchema(Context context) {
    ...
    private boolean checkDatabase(){
        ...
        try{
            String myPath = DBSchema.PATH + DBSchema.DATABASE_NAME;

...
public class TextStyleContract implements Contract {
    public static final String path_ttypeoftext = "typeoftext";
    public static final class TextStyleEntry implements BaseColumns {
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(path_ttypeoftext).build();

        public static final String DATABASE_TABLE = "text_style";
